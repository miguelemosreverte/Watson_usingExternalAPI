...
app.post('/api/message', function(req, res) {
  ...
  conversation.message(payload, function(err, data) {
    ...
    return res.json(processMessage(payload, data));
  });
});

function processMessage(input, response) {
    /*rp('http://www.ibm.com')
      .then(function (external_API_response) {

        return updateMessage(input, response);
